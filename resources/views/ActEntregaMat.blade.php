...
table.table-bordered > tbody > tr > td{
    border:1px dark;
              ...
              <?php
                 $trabajador = $dato['tra_nombre_apellido'];
                 $fechaInicio = $dato['nfechaI'];
                 $descripcionServicio = $dato['descripcionServicio'];
                 $id_solicitud = $dato['id_solicitud'];
                 $supervisor = $dato['sup_nombre_apellido'];
              ?>
              @endforeach
    <body>
        <div class="container">
            <div class="row">
              <div class="col-xs-2"> <img src="http://10.4.237.120:8001/Documentos/1.png"></div>
                <div class="col-xs-10">
                  <h3 id="tituloOrd"><b>Acta Entrega de Materiales</b> </h3>
                  <h4 id="subOrd"><b>Bodega RRFF</b> </h4>                  
                </div>
            ...
            <div class="row">
              ...
              <tbody>
                 ...
                 <tr>
                   <td><?php echo $dat['descripcion_material'] ?></td>
                   <td><?php echo $dat['material_cantidad'] ?></td>
                 </tr>
