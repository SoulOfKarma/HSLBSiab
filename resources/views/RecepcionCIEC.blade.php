  ...
  width: 100%;
    ...
    <body>
                ...
                <table class="table table-borderless table-sm">
                    <tbody>
                      <tr>
                        ...
                        <td style="text-align: center;  width: 500px;"><b>Consumo Inmediato </b>
                            <b>N° {{$nfolio}}</b><br><br>
        ...
        <footer class="main-footer" style="position:fixed;bottom:0">
            <div class="float-left d-none d-xs-block">
                <table class="table table-borderless table-sm">
                    <tbody>
                        <tr id="OrdenTabla">
                          ...
                          <tr>
                           <td style="width: 7.33%" class="badge badge-secondary "><h6>Firma Usuario</h6></td>
                           <td style="width: 7.33%" class="badge badge-secondary "><h6>Encargado Abastecimiento</h6></td>
