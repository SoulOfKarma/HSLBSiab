<template>
    <div>
        <vx-card title="Economato">
            <div>
                <vs-button color="primary" type="filled" @click="popEconomato"
                    >Agregar Economato</vs-button
                >
            </div>
            <br />
            <div>
                    ...
                    >
                        <template slot="table-row" slot-scope="props">
                            ...
                            <span v-else-if="props.column.field === 'action'">
                                ...
                                ></plus-circle-icon>
                                <plus-circle-icon
                                    content="Agregar Codigo Economato"
                                    v-tippy
                                    size="1.5x"
                                    class="custom-class"
                                    @click="
            ...
            <!-- Agregar -->
            <vs-popup
                classContent="AgregarEco"
                title="Agregar Economato"
                :active.sync="popUpEco"
            >
            ...
            <vs-popup
                classContent="EcoMod"
                title="Modificar Economato"
                :active.sync="popUpEcoMod"
            >
                <div class="vx-col md:w-1/1 w-full mb-base">
                    <vx-card title="">
                        <div class="vx-row">
            ...
            <vs-popup
                ...
                title="Agregar Codigo Economato"
                        ...
                        <div class="vx-row">
                            ...
                            <div class="vx-col w-1/2 mt-5">
                                ...
                                <vs-button
                                    ...
                                    type="filled"
                                    class="w-full"
                                    >Agregar Codigo Economato</vs-button
                                >
                            </div>
                        </div>
                        <div class="vx-row">
...
export default {
    ...
    methods: {
        ...
        TraerEconomato() {
            try {
                axios
                    .get(this.localVal + "/api/Mantenedor/GetEconomato", {
                        headers: {
                            Authorization:
                                `Bearer ` + sessionStorage.getItem("token")
                        }
                        ...
                        .then(res => {
                            ...
                            if (solicitudServer == true) {
                                this.$vs.notify({
                                    time: 5000,
                                    title: "Completado",
                                    text: "Codigo Economato Correctamente",
                                    color: "success",
                                    position: "top-right"
                                });
                                this.TraerEconomato();
                                ...
                                this.$vs.notify({
                                    ...
                                    title: "Error",
                                    text:
                                        "No fue posible agregar el codigo de Economato,intentelo nuevamente",
                                    color: "danger",
                                    position: "top-right"
                                });
                            }
