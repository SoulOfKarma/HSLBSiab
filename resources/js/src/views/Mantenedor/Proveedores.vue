            ...
            try {
                if (this.rutProveedor == "" || this.rutProveedor == null) {
                    ...
                    let data = {
                        ...
                        NOMRAZSOC: this.razonSocial.toUpperCase(),
                        DIRPROV: this.direccionProveedor.toUpperCase(),
                        TELPROV: this.telefonoProveedor,
                        CELPROV: this.celularProveedor,
                        EMAILPROV: this.emailProveedor.toUpperCase(),
                        NOMVENPROV: this.vendedorProveedor.toUpperCase(),
                        LLAVEPROVEEDOR: "-",
                        CODFORMAPAGO: "-",
                        CODCOM: "-",
                        CODCIU: "-",
