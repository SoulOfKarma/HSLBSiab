<template>
    <div>
        <vx-card title="Listado Despachos Abiertos">
            <br />
            <div>
                <vx-card>
                    <vue-good-table
                        ...
                        <template slot="table-row" slot-scope="props">
                            ...
                            <span v-else-if="props.column.field === 'action'">
                                <plus-circle-icon
                                    ...
                                    class="custom-class"
                                    @click="
                                        redireccionarDespachosAbiertos(
                                            props.row.NUMINT
                                        )
                                    "
                                ></plus-circle-icon>
...
export default {
    ...
    methods: {
        ...
        //Metodos CRUD
        TraerDespachosAbiertos() {
            try {
                axios
                    .get(
                        this.localVal + "/api/Despachos/GetDespachosAbiertos",
                        {
                            headers: {
                                Authorization:
        ...
        redireccionarDespachosAbiertos(numinterno) {
            try {
                this.$router.push({
