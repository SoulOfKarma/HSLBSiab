...
class MaterialInventariosController extends Controller
{
    ...
    public function PutInventario(Request $request){
       try {
           ...
           'id_material_medida' => $request->id_material_medida,'material_cantidad' => $request->material_cantidad,'material_cantidad_minima' => $request->material_cantidad_minima,'material_valor' => $request->material_valor,
    ...
    public function TraerMaterialEspecifico($id){
        try {
            ...
            'material_inventarios.material_cantidad','material_inventarios.material_cantidad_minima','material_inventarios.material_valor')
    ...
    public function getStockTotal(){
        $get_all = MaterialInventarios::select('material_ingresados.descripcion_material',
        'material_inventarios.id_material_medida',DB::raw('sum(material_inventarios.material_cantidad) as total'),
        DB::raw('sum(material_inventarios.material_cantidad_calculada) AS total_cal'))
        ->join('material_ingresados','material_inventarios.id_material_ing','=','material_ingresados.id')
